...
Given total number of soldiers initially.
    ...
    Explanation: The 1st and 3rd soldier will be killed in the first round. Hence, Daryl will be on the 2nd position with 1 person between him and Abraham.

    Test Input 2: 4

    Output: 3

    Explanation: The 1st and 3rd soldier will be killed in the first round. In the 2nd round, only the soldier standing at position 2 will be dead. Therefore, 3 soldiers must stand between them.
 */
